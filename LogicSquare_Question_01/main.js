  ...
  function generateStudentMarkSheets(students, details) {
    ...
    for (const student of students) {
      ...
      if (studentDetails) {
        ...
        // Create a well-formatted mark sheet object for clarity
        const markSheet = {
          name: student.name,
          Roll: student.Roll,
          ...subjects,
        ...
        // Handle cases where student details are not found
      console.warn(`Student with Roll number ${student.Roll} not found in details.`);
      }
    }
